  ...
  return (
    <div className="relative min-h-[calc(100vh-64px)] w-full bg-[var(--bg-main)] text-[var(--text-primary)] flex flex-col justify-center overflow-x-hidden py-4 sm:py-8 lg:py-10 transition-colors duration-300">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div 
          className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[550px] h-[350px] sm:h-[550px] blur-[140px] rounded-full pointer-events-none opacity-40 transition-all duration-700" 
          style={{ background: mode === 'login' ? 'var(--accent-cyan)' : 'var(--accent-violet)' }}
        />
        <div 
          className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-[350px] sm:w-[550px] h-[350px] sm:h-[550px] blur-[160px] rounded-full pointer-events-none opacity-30 transition-all duration-700" 
      ...
      <main className="relative z-10 w-full max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center my-auto">
        ...
        {/* 🏆 LEFT COLUMN: Holographic Arena & League Showcase (Desktop Only) */}
        ...
        <div className="w-full lg:col-span-6 xl:col-span-5 flex justify-center">
          ...
          >
            <div className="p-5 sm:p-7 md:p-8 space-y-4 sm:space-y-5">
              ...
              {/* Top Mode Segmented Switcher Tab */}
              <Card3DItem depth={25}>
                <div className="relative p-1 rounded-2xl bg-[var(--bg-subtle)] border border-[var(--border-card)] flex items-center justify-between">
                  
                  {/* Sliding Indicator Background */}
                  <button
                    type="button"
                    onClick={() => switchMode('login')}
                    className={`relative z-10 flex-1 py-2 rounded-xl text-xs font-black uppercase tracking-wider transition-colors duration-200 flex items-center justify-center gap-2 ${
                      mode === 'login'
                  ...
                  >
                    ...
                    <div className="text-center space-y-1.5 pt-1">
                      ...
                      <div>
                        ...
                        <h2 className="text-xl sm:text-2xl font-black uppercase tracking-tight text-[var(--text-heading)] font-display">
                          Acceso a la Arena
                        </h2>
                    ...
                    <div className="pt-1 text-center text-xs text-[var(--text-muted)] font-medium">
                      ...
                      <button
                        type="button"
                        onClick={() => switchMode('register')}
                        className="font-bold text-[var(--accent-cyan)] hover:brightness-125 hover:underline transition-colors ml-1 cursor-pointer"
                      >
