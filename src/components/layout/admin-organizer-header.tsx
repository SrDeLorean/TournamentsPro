...
import {
  Trophy, Shield, Settings, LogOut, LayoutDashboard, User, MessageSquare, Sun, Moon, Globe, CheckCircle2, ChevronDown, Sparkles
} from 'lucide-react';
      ...
      <div className="w-full px-4 sm:px-6 h-full flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-cyan-500 via-purple-600 to-amber-500 p-0.5 shadow-lg group-hover:scale-105 transition-transform">
          ...
          <Badge variant={isAdmin ? 'cyan' : 'emerald'} className="hidden sm:inline-flex text-[9px] font-mono uppercase font-bold">
            {isAdmin ? '🛡️ ADMINISTRACIÓN GLOBAL' : '🏆 CIRCUITO DE ORGANIZACIÓN'}
          </Badge>
        </div>
