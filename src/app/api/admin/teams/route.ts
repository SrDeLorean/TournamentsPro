...
export async function GET(request: Request) {
  try {
    ...
    const parsedTeams = teams.map((t) => ({
      ...
      logo_url: t.logoUrl || (t as any).logo_url || null,
      logoUrl: t.logoUrl || (t as any).logo_url || null,
      banner_url: t.bannerUrl || (t as any).banner_url || null,
      bannerUrl: t.bannerUrl || (t as any).banner_url || null,
